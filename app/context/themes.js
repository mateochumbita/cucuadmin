const themes = [
  {
    name: "default",
    colorBg: "#fff", // Anteriormente "#252525"
    colorBg2: "#F9F9F9", // Anteriormente "#212121"
    colorBg3: "#EDEDED", // Anteriormente "#181818"
    colorBg4: "#1A1A1A",
    colorButton: "black",
    colorDanger: "#fe6854",
    colorFontPrimary: "#6c7983", // Anteriormente "#e5e7eb"
  ...
  {
    name: "light",
    colorBg: "#252525", // Anteriormente "#fff"
    colorBg2: "#212121", // Anteriormente "#F9F9F9"
    colorBg3: "#181818", // Anteriormente "#EDEDED"
    colorBg4: "#1A1A1A",
    colorButton: "#3A3B3C",
    colorDanger: "#fe6854",
    colorTextSecondary: "#B0B3B8",
    colorFontPrimary: "#e5e7eb", // Anteriormente "#6c7983"
    colorTextPrimary: "#FFFFFF",
    colorTextLight: "#f8f8f8",
    colorbackground: "#FBFBFD",
    colorGradient: "linear-gradient(110.42deg, #CF57A3 29.2%, #4731B6 63.56%)",
